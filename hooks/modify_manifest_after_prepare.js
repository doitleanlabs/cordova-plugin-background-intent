...
module.exports = function (context) {
  ...
  xml2js.parseString(manifestXml, (err, result) => {
    ...
    if (customPermission) {
      ...
      const hasPermission = manifest['permission'].some(p => p.$['android:name'] === customPermission);
      ...
      if (!hasPermission) {
        ...
        console.log(`✅ Permission declaration added: ${customPermission}`);
      } else {
        console.log(`ℹ️ Permission already declared: ${customPermission}`);
      }
